...
export default function Home() {
  return (
    <div className="bg-[#0A0A0A] text-white">
      ...
      <nav className="sticky top-0 z-50 bg-[#0A0A0A]/95 backdrop-blur border-b border-[#64748B]/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link to="/login" className="text-[#E5E7EB] hover:text-[#d4af37] transition">
              Login
            </Link>
            <Link
              to="/signup"
      ...
      <section id="features" className="bg-[#0A0A0A]/50 border-y border-[#64748B]/20 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: Users, title: "Global Community", description: "Connect with thousands of skilled individuals from around the world" },
              { icon: Zap, title: "Instant Matching", description: "Find the perfect skill swap match based on your interests and expertise" },
              { icon: Shield, title: "Secure & Verified", description: "All users are verified to ensure a safe and trustworthy environment" },
              { icon: TrendingUp, title: "Track Progress", description: "Monitor your learning journey and celebrate your achievements" },
              { icon: Star, title: "Expert Ratings", description: "Build your reputation through verified reviews and ratings" },
              { icon: ArrowRight, title: "Easy Integration", description: "Seamlessly integrate with your calendar and communication tools" },
            ].map((feature, i) => (
              <div
                key={i}
      ...
      {/* Community Stats */}
      <section id="community" className="bg-gradient-to-r from-[#d4af37]/10 to-transparent border-y border-[#64748B]/20 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-[#64748B]">
                <li><a href="#" className="hover:text-[#d4af37] transition">Features</a></li>
                <li><a href="#" className="hover:text-[#d4af37] transition">Pricing</a></li>
